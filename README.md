[![Build Status](https://jenkins.braintwister.eu/buildStatus/icon?job=BrainTwister/benchmark/master)](https://jenkins.braintwister.eu/job/BrainTwister/job/benchmark/job/master/)
